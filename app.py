...
def process(side, file_path):
    ...
    save_path = f"/home/ubuntu/static{side}_output.jpg"
...
if not firebase_admin._apps:
    cred = credentials.Certificate('/home/ubuntu/insuranceclaimdb-firebase-adminsdk-nqj5n-dbf0c37136.json')
    ...
    if request.method == 'POST':
        ...
        for side in ['front', 'back', 'left', 'right']:
            ...
            if file and allowed_file(file.filename):
                ...
                file_path = f"/home/ubuntu/static/{side}_input.jpg"
                file.save(file_path)
